...
export function ChatWindow({ conversation, presenceMap, typingUsers, newMessages, onAudioCall, onVideoCall, ongoingCall, onJoinCall, onBack }: ChatWindowProps) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto bg-[#f0f2f5] py-3 md:py-4 px-2 md:px-0">
        {isLoading ? (
